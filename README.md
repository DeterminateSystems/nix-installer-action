...
| `determinate-nix-config` | A string of literal JSON to write to `/etc/determinate/config.json` before installing. Rejected if not valid JSON; if `/etc/determinate/config.json` already exists it is overwritten with a warning.                                                                          | string                                     |                                                                |
