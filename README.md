...
| `flakehub`               | Log in to FlakeHub to pull private flakes using this repository's FlakeHub permissions, using the GitHub Actions JWT which is bound to the flakehub audience.                                         | Boolean                                    | `false`                                              |
