...
| `flake-checker-send-telemetry` | Anonymously report [the number of detected issues](https://github.com/DeterminateSystems/flake-checker/#telemetry) for measure the effectiveness of the flake checker. To disable set, to false. Forced to off by changing the `diagnostic-endpoint` option. | bool                                       | `true`                                               |
